    ...
    render() {
        return (
            <Form core={this.core} layout={{label: 9}}>
                ...
                <FormItem required={true} label="年份 "  name="year" ><InputNumber placeholder="2019" style={{width:230}}/></FormItem>
                ...
                <FormItem required={true} label="检测机构的新增" name="jianceIncrease"><InputNumber style={{width:230}}/></FormItem>
                <FormItem required={true} label="体检机构的新增" name="tijianIncrease"><InputNumber style={{width:230}}/></FormItem>
                <FormItem required={true} label="诊断机构的新增" name="zhenduanIncrease"><InputNumber style={{width:230}}/></FormItem>

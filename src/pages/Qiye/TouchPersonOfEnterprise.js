...
//
import TouchPersonOfEnterpriseDemoForm from '../QiyeDemoFrom/TouchPersonOfEnterpriseDemoForm'
        ...
        return (
            <List url='/zyb/touchPersonOfEnterprise/list' onError={this.handleError} onMount={this.onMount}>
                ...
                <Table onRow={record => {
                    ...
                    <Table.Column title="上岗时间" dataIndex="startDate"/>
                    <Table.Column title="离岗时间" dataIndex="leaveDate"/>
                    <Table.Column title="接害工龄" dataIndex="touchYear"/>
                    <Table.Column title="是否缴纳工伤保险" dataIndex="isBuy"/>
                    <Table.Column title="是否签订劳动合同" dataIndex="isSign"/>
                </Table>
                <Pagination/>
            </List>
        )
...
export default TouchPersonOfEnterprise
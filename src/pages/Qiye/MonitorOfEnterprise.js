...
//
import MonitorOfEnterpriseDemoForm from '../QiyeDemoFrom/MonitorOfEnterpriseDemoForm'
...
// @connect(({demo}) => ({demo}))
class MonitorOfEnterprise extends PureComponent {
    state = {fileList: []
    }
    putFileToState = file => {
        ...
        return (
            <List url='/zyb/monitorOfEnterprise/list'onError={this.handleError} onMount={this.onMount}>
                ...
                <Table onRow={record => {
                    ...
                    <Table.Column title="监测周期" dataIndex="cycle"/>
                    <Table.Column title="监测时间" dataIndex="monitorTime"/>
                    <Table.Column title="监测结果" dataIndex="monitorResult"/>
...
export default MonitorOfEnterprise
...
class ServiceSuperviseOfSupervise extends PureComponent {
        ...
        if ('create' === type) {
            ...
            Dialog.show({
                ...
                onOk: (values, hide) => {
                    ...
                    //异步请求
                    request.post('/zybadmin/serviceSuperviseOfSupervise/exceladd',{method: 'post', data: formData}).then(res => {
                        if(res.flag){
    ...
    render() {
        return (
                ...
                <List url='/zybadmin/serviceSuperviseOfSupervise/list'  onError={this.handleError} onMount={this.onMount}>
                    <Filter cols={2}>

...
export default class OtherGovVisual extends Component {
    ...
    yearOnChange = year => {
        ...
        //option1
        request('/zyb/otherGovVisual/' + switchFlag + '/option1', params).then(res => {
            if (res && res.flag) {
                this.setState({option1Data: res.data})
            }
        })
        //option2
        request('/zyb/otherGovVisual/' + switchFlag + '/option2', params).then(res => {
            if (res && res.flag) {
                this.setState({option2Data: res.data})
            }
        })
        request('/zyb/otherGovVisual/' + switchFlag + '/option2Detail', params).then(res => {
            if (res && res.flag) {
                this.setState({option2Detail: res.data})
            }
        })
        //option3
        request('/zyb/otherGovVisual/' + switchFlag + '/option3', params).then(res => {
            if (res && res.flag) {
                this.setState({option3Data: res.data})
            }
        })
        //option4
        request('/zyb/otherGovVisual/' + switchFlag + '/option4', params).then(res => {
            if (res && res.flag) {

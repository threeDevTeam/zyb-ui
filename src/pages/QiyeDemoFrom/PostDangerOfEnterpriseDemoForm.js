...
class PostDangerOfEnterpriseDemoForm extends PureComponent {
    ...
    monthOptions = [{label: "1", value: 1}, {label: "2", value: 2}, {label: "3", value: 3}, {label: "4", value:4}, {label: "5", value:5}, {label: "6", value: 6}, {label: "7", value: 7}, {label: "8", value: 8}, {label: "9", value: 9}, {label: "10", value: 10}, {label: "11", value: 11}, {label: "12", value: 12}]
    ...
    render() {
        return (
            <Form core={this.core} layout={{label: 9}}>
                ...
                <FormItem required={true} label="申报年份" value={2019} name="upYear"><InputNumber
                    style={{width: 230}}/></FormItem>
                <FormItem required={true} label="申报月份" name="upMonth">
                    <Select style={{width: 230}} options={this.monthOptions}/>
                </FormItem>
                <FormItem required={true} label="职业病危害因素名称" name="cascaded1"><Cascader style={{width: 230}}
                                                                                       options={this.state.dataSource1}
                                                                                       onChange={this.onChange}
                                                                                       placeholder="职业病危害因素名称"/></FormItem>

                <FormItem required={true} label="可能导致的职业病名称" name="cascaded2"><Cascader style={{width: 230}}
                                                                                        options={this.state.dataSource2}
                                                                                        onChange={this.onChange}
                                                                                        placeholder="可能导致的职业病名称"/></FormItem>
                ...
                <FormItem required={true} label="接触频次" name="touchFrequency"><InputNumber
                    style={{width: 230}}/></FormItem>

...
componentWillMount() {
 ...
 <FormItem label="申报时间" name="upDatee"><InputNumber/></FormItem>
 <FormItem label="申报年份" name="upYear"><InputNumber/></FormItem>
 <FormItem label="申报月份" name="upMonth"><InputNumber/></FormItem>
  <FormItem label="职业病危害因素名称" name="cascaded1"><Cascader options={this.state.dataSource1}  onChange={this.onChange} placeholder="职业病危害因素名称"/></FormItem>

  <FormItem label="可能导致的职业病名称" name="cascaded2"><Cascader options={this.state.dataSource2}  onChange={this.onChange} placeholder="可能导致的职业病名称"/></FormItem>
 ...
 <FormItem label="作业方式" name="touchMode">

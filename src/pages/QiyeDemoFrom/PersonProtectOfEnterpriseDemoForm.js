...
count: {type: "number", required: true, message: '发放数量不能为空'},
...
componentWillMount() {
 ...
 this.core.setValue('isCorrect','是')
 this.core.setValue('isReplace','是')
 ...
 <FormItem required={true} label="发放数量" name="count"><InputNumber/></FormItem>

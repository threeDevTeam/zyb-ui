...
componentWillMount() {
 ...
 <FormItem required={true} label="年龄" name="age"><InputNumber style={{width: 230}} /></FormItem>
  <FormItem required={true} label="职业病名称" name="cascaded5"><Cascader style={{width: 230}} options={this.state.dataSource5}  onChange={this.onChange} placeholder="职业病名称"/></FormItem>

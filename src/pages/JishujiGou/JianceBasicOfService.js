...
//
import JianceBasicOfServiceDemoForm from '../JiShuDemoFrom/JianceBasicOfServiceDemoForm'
...
// @connect(({demo}) => ({demo}))
class JianceBasicOfService extends PureComponent {
    state = { fileList: []
    }
    putFileToState = file => {
...
export default JianceBasicOfService